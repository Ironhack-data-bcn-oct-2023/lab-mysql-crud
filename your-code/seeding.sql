...
INSERT INTO customer (customer_id, name, phone, email, address, city, state_province, country, postal) VALUES
(10001, 'Pablo Picasso', '+34 636 17 63 82', '-', 'Paseo de la Chopera, 14', 'Madrid', 'Madrid', 'Spain', '28045'),
(20001, 'Abraham Lincoln', '+1 305 907 7086', '-', '120 SW 8th St', 'Miami', 'Florida', 'United States', '33130'),
(30001, 'Napoléon Bonaparte', '+33 1 79 75 40 00', '-', '40 Rue du Colisée', 'Paris', 'Île-de-France', 'France', '75008');

INSERT INTO salesperson (staff_id, staff_name, company_store) VALUES
...
INSERT INTO invoices (invoice_number, date, vin, customer_id, staff_id) VALUES
(852399038, '2018-08-22', 1, 10001, 3),
(731166526, '2018-12-31', 2, 20001, 5),
